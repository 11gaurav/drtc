...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="assets/css/style.css">
    ...
    <link rel='stylesheet' id='picker-classic-css' href='<?php echo base_url(); ?>assets/css/classic63d3.css?ver=4.0.67' media='all' />
    <link rel='stylesheet' id='picker-classic-date-css' href='<?php echo base_url(); ?>assets/css/classic.date63d3.css?ver=4.0.67' media='all' />
    <link rel='stylesheet' id='wbk-frontend-style-custom-css' href='<?php echo base_url(); ?>assets/css/wbk-frontend-custom-style63d3.css?ver=4.0.67' media='all' />
    <link rel='stylesheet' id='wbk-frontend-style-css' href='<?php echo base_url(); ?>assets/css/wbk-frontend-default-style63d3.css?ver=4.0.67' media='all' />
    <link rel='stylesheet' id='wpforms-full-css' href='<?php echo base_url(); ?>assets/css/wpforms-full.min694e.css?ver=1.6.7' media='all' />
    <link rel='stylesheet' id='elementor-icons-ekiticons-css' href='<?php echo base_url(); ?>assets/css/ekiticonsc936.css?ver=2.3.1.1' media='all' />
    <link rel='stylesheet' id='elementor-icons-css' href='<?php echo base_url(); ?>assets/css/elementor-icons.min21f9.css?ver=5.11.0' media='all' />
    <link rel='stylesheet' id='elementor-animations-css' href='<?php echo base_url(); ?>assets/css/animations.min2072.css?ver=3.2.5' media='all' />
    <link rel='stylesheet' id='elementor-post-6-css' href='<?php echo base_url(); ?>assets/css/post-6cda9.css?ver=1626617656' media='all' />
    ...
    <link rel='stylesheet' id='elementor-icons-shared-0-css' href='<?php echo base_url(); ?>assets/css/fontawesome.min9e0b.css?ver=5.15.1' media='all' />
    <link rel='stylesheet' id='elementor-icons-fa-brands-css' href='<?php echo base_url(); ?>assets/css/brands.min9e0b.css?ver=5.15.1' media='all' />
    <link rel='stylesheet' id='elementor-icons-fa-solid-css' href='<?php echo base_url(); ?>assets/css/solid.min9e0b.css?ver=5.15.1' media='all' />
    <link rel='stylesheet' id='elementor-icons-fa-regular-css' href='<?php echo base_url(); ?>assets/css/regular.min9e0b.css?ver=5.15.1' media='all' />
    <script src='<?php echo base_url(); ?>assets/js/jquery.min9d52.js?ver=3.5.1' id='jquery-core-js'></script>
    <script src='<?php echo base_url(); ?>assets/js/jquery-migrate.mind617.js?ver=3.3.2' id='jquery-migrate-js'>
    </script>
    <script src='<?php echo base_url(); ?>assets/js/cht-front-script283e.js?ver=1625861137' id='chaty-front-end-js'>
    </script>
    <script src='<?php echo base_url(); ?>assets/js/core.min35d0.js?ver=1.12.1' id='jquery-ui-core-js'></script>
    <script src='<?php echo base_url(); ?>assets/js/effect.min35d0.js?ver=1.12.1' id='jquery-effects-core-js'></script>
    <script src='<?php echo base_url(); ?>assets/js/wbk-validator9f31.js?ver=5.7.2' id='wbk-validator-js'></script>
    <script src='<?php echo base_url(); ?>assets/js/jquery.maskedinput.min9f31.js?ver=5.7.2' id='jquery-maskedinput-js'>
    </script>
    <script src='<?php echo base_url(); ?>assets/js/wbk-frontend63d3.js?ver=4.0.67' id='wbk-frontend-js'></script>
    <script src='<?php echo base_url(); ?>assets/js/she-header370e.js?ver=1.4.3' id='she-header-js'></script>
    <script src='<?php echo base_url(); ?>assets/js/wbk63d3.js?ver=4.0.67' id='wbk-common-script-js'></script>
    <link rel="https://api.w.org/" href="wp-json/index.html" />
    <link rel="alternate" type="application/json" href="json/1456.json" />
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="xmlrpc0db0.php?rsd" />
    <link rel="wlwmanifest" type="application/wlwmanifest+xml" href="<?php echo base_url(); ?>assets/css/wlwmanifest.xml" />
...
<body itemtype='https://schema.org/WebPage' itemscope='itemscope' class="page-template-default page page-id-1456 wp-custom-logo ast-single-post ast-inherit-site-logo-transparent ast-theme-transparent-header ast-hfb-header ast-desktop ast-page-builder-template ast-no-sidebar astra-3.4.6 elementor-default elementor-kit-6 elementor-page elementor-page-1456">
    <div class="hfeed site" id="page">
        ...
        <header style="position: fixed;" class="site-header header-main-layout-1 ast-primary-menu-enabled ast-logo-title-inline ast-hide-custom-menu-mobile ast-builder-menu-toggle-icon ast-mobile-header-inline" id="masthead" itemtype="https://schema.org/WPHeader" itemscope="itemscope" itemid="#masthead">
            <div id="ast-desktop-header" data-toggle-type="dropdown">
                <div class="ast-main-header-wrap main-header-bar-wrap ">
                    <div class="ast-primary-header-bar ast-primary-header main-header-bar site-header-focus-item" data-section="section-primary-header-builder">
                        <div class="site-primary-header-wrap ast-builder-grid-row-container site-header-focus-item ast-container" data-section="section-primary-header-builder" style="max-width: 1340px;">
                            <div class="ast-builder-grid-row ast-builder-grid-row-has-sides ast-builder-grid-row-no-center">
                                <div class="site-header-primary-section-left site-header-section ast-flex site-header-section-left">
                                    <div class="ast-builder-layout-element ast-flex site-header-focus-item" data-section="title_tagline">
                                        <div class="site-branding ast-site-identity" itemtype="https://schema.org/Organization" itemscope="itemscope">
                                            <span class="site-logo-img"><a href="<?php echo base_url(); ?>" class="custom-logo-link" rel="home"><img width="268" height="42" src="assets/img/cropped-image-removebg-preview-2-268x42.png" class="custom-logo" alt="" srcset="<?php echo base_url(); ?>/assets/img/cropped-image-removebg-preview-2-268x42.png 268w" , srcsect="assets/img/cropped-image-removebg-preview-2-300x47.png 300w" ,srcset="assets/img/cropped-image-removebg-preview-2.png 457w" sizes="(max-width: 268px) 100vw, 268px" /></a></span>
                                            <div class="ast-site-title-wrap">
                                                <span class="site-title" itemprop="name">
                                                    <a href="<?php echo base_url(); ?>" rel="home" itemprop="url"></a>
                                                </span>
                                            </div>
                                        </div>
                                        <!-- .site-branding -->
                                ...
                                <div class="site-header-primary-section-right site-header-section ast-flex ast-grid-right-section">
                                                    ...
                                                    <div class="main-navigation ast-inline-flex">
                                                        <ul id="ast-hf-menu-1" class="main-header-menu ast-nav-menu ast-flex  submenu-with-border stack-on-mobile">
                                                            ...
                                                            <li id="menu-item-330" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-330">
                                                                <a href="our_services" class="menu-link">Our
                                                                    Services</a>
                                                            </li>
                                                            <li id="menu-item-1037" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1037">
                                                                ...
                                                                <ul class="sub-menu">
                                                                    <li id="menu-item-944" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-944">
                                                                        <a href="timeAndDistance" class="menu-link"><span class="ast-icon icon-arrow"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enable-background="new 57 35.171 26 16.043" xml:space="preserve">
                                                                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                                                                </svg></span>Time &#038; Distance
                                                                            Calculator</a>
                                                                    </li>
                                                                    <li id="menu-item-977" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-977">
                                                                        <a href="pickupRequest" class="menu-link"><span class="ast-icon icon-arrow"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="26px" height="16.043px" viewBox="57 35.171 26 16.043" enable-background="new 57 35.171 26 16.043" xml:space="preserve">
                                                                                    <path d="M57.5,38.193l12.5,12.5l12.5-12.5l-2.5-2.5l-10,10l-10-10L57.5,38.193z" />
                                                                                </svg></span>Pickup Request</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                    ...
                                    <div class="ast-builder-layout-element ast-flex site-header-focus-item ast-header-button-1" data-section="section-hb-button-1">
                                        <div class="ast-builder-button-wrap ast-builder-button-size-"><a class="ast-custom-button-link" href="#" target="_blank">
                                                <div class=ast-custom-button>Login</div>
                                            </a><a class="menu-link" href="#" target="_blank">Login</a></div>
                                    </div>
                    ...
                    <div class="ast-primary-header-bar ast-primary-header main-header-bar site-primary-header-wrap site-header-focus-item ast-builder-grid-row-layout-default ast-builder-grid-row-tablet-layout-default ast-builder-grid-row-mobile-layout-default" data-section="section-transparent-header">
                        <div class="ast-builder-grid-row ast-builder-grid-row-has-sides ast-builder-grid-row-no-center">
                            <div class="site-header-primary-section-left site-header-section ast-flex site-header-section-left">
                                <div class="ast-builder-layout-element ast-flex site-header-focus-item" data-section="title_tagline">
                                    <div class="site-branding ast-site-identity" itemtype="https://schema.org/Organization" itemscope="itemscope">
                                        <span class="site-logo-img"><a href="<?php echo base_url();  ?>" class="custom-logo-link" rel="home"><img width="268" height="42" src="<?php echo base_url(); ?>assets/img/cropped-image-removebg-preview-2-268x42.png" class="custom-logo" alt="" srcset="<?php echo base_url(); ?>assets/img/cropped-image-removebg-preview-2-268x42.png 150w, <?php echo base_url(); ?>assets/img/cropped-image-removebg-preview-2-268x42.png 300w,<?php echo base_url(); ?>assets/img/cropped-image-removebg-preview-2-268x42.png 457w" sizes="(max-width: 268px) 100vw, 268px" /></a></span>
                                        <div class="ast-site-title-wrap">
                                            <span class="site-title" itemprop="name">
                                                <a href="<?php echo base_url(); ?>" rel="home" itemprop="url">
                                ...
                                <nav class="site-navigation" id="site-navigation" itemtype="https://schema.org/SiteNavigationElement" itemscope="itemscope" class="ast-flex-grow-1 navigation-accessibility" aria-label="Site Navigation">
                                    <div id="ast-hf-mobile-menu" class="main-navigation">
                                        <ul class="main-header-menu ast-nav-menu ast-flex  submenu-with-border astra-menu-animation-fade  stack-on-mobile">
                                            <li class="page_item page-item-151 menu-item"><a href="<?php echo base_url(); ?>/aboutUs/" class="menu-link">About
                                                    Us</a></li>
                                            ...
                                            <li class="page_item page-item-1057 menu-item"><a href="<?php echo base_url(); ?>/haryana-contacts/" class="menu-link">Haryana Contacts</a></li>
                                            <li class="page_item page-item-7 menu-item"><a href="<?php echo base_url(); ?>" class="menu-link">Home Page</a>
                                            </li>
                                            ...
                                            <li class="page_item page-item-976 menu-item"><a href="pickupRequest" class="menu-link">Pickup
                                                    Request</a></li>
                                            <li class="page_item page-item-995 menu-item"><a href="<?php echo base_url(); ?>/tax-forms/" class="menu-link">Tax
                                                    Forms</a></li>
